...
#     """Thermal emission from an asteroid or comet nucleus."""

#     def __init__(self, shape: Shape, surface: Surface):
...
# class NonRotThermalModel(ThermalEmission):
#     """Non-rotating / instantaneous temperature distribution."""
