    ...
    fieldnames_info = [
        ...
        {'description': 'Z Velocity Vector Component',
         ...
         {'description': 'Apparent planetodetic Solar latitude',
          'fieldnames': ['pldeticSol_lat', 'pltdeticSol_lat'],
          'provenance': ['ephem', 'obs'],
          'dimension': 'angle'},
         ...
         {'description': 'Observation centric ecliptic latitude',
          ...
          'provenance': ['ephem', 'obs'],
          'dimension': 'angle'},
         {'description': 'Heliocentric radial rate',
          'fieldnames': ['r_rate', 'rdot'],
          'provenance': ['ephem', 'obs'],
          'dimension': 'velocity'},
         {'description': 'Observation centric radial rate',
          'fieldnames': ['deltarate', 'Deltarate'],
          'provenance': ['ephem', 'obs'],
          'dimension': 'velocity'},
         ...
         {'description': 'Local apparent solar time',
          ...
          'provenance': ['ephem', 'obs'],
          'dimension': None},
         {'description': 'Observert light time from Earth',
          'fieldnames': ['earthlighttime', 'Earthlightime'],
          'provenance': ['ephem', 'obs'],
          'dimension': 'time'},
         ...
         {'description': '3 sigma doppler round-trip delay uncertainty',
          ...
          'dimension': 'time'},
         {'description': 'True anomaly',
          'fieldnames': ['true_anomaly', 'True_anomaly'],
          'provenance': ['ephem', 'obs'],
          'dimension': 'angle'},
