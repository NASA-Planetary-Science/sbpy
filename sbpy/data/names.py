...
class Names():
    ...
    def parse_comet(s):
        ...
        +--------------------------------+---------------------------------+
        |targetname                      |number, typ, fragm, desig, name  |
        +================================+=================================+
        |1P/Halley                       |1, 'P', None, None, 'Halley'     |
        +--------------------------------+---------------------------------+
        |3D/Biela                        |3, 'D', None, None, 'Biela'      |
        +--------------------------------+---------------------------------+
        |9P/Tempel 1                     |9, 'P', None, None, 'Tempel 1'   |
        +--------------------------------+---------------------------------+
        |73P/Schwassmann Wachmann 3 C    |73, 'P', None, None,             |
        |                                | 'Schwassmann Wachmann 3 C'      |
        +--------------------------------+---------------------------------+
        |73P-C/Schwassmann Wachmann 3 C  |73, 'P', 'C', None,              |
        |                                | 'Schwassmann Wachmann 3 C'      |
        +--------------------------------+---------------------------------+
        |73P-BB                          |73, 'P', 'BB', None, None        |
        +--------------------------------+---------------------------------+
        |322P                            |322, 'P', None, None, None       |
        +--------------------------------+---------------------------------+
        |X/1106 C1                       |None, 'X', None, '1066 C1',      |
        |                                | None                            |
        +--------------------------------+---------------------------------+
        |P/1994 N2 (McNaught-Hartley)    |None, 'P', None, '1994 N2',      |
        |                                | 'McNaught-Hartley'              |
        +--------------------------------+---------------------------------+
        |P/2001 YX127 (LINEAR)           |None, 'P', None, '2001 YX127',   |
        |                                | 'LINEAR'                        |
        +--------------------------------+---------------------------------+
        |C/-146 P1                       |None, 'C', None, '-146 P1',      |
        |                                | None                            |
        +--------------------------------+---------------------------------+
        |C/2001 A2-A (LINEAR)            |None, 'C', 'A', '2001 A2',       |
        |                                | 'LINEAR'                        |
        +--------------------------------+---------------------------------+
        |C/2013 US10                     |None, 'C', None, '2013 US10',    |
        |                                | None                            |
        +--------------------------------+---------------------------------+
        |C/2015 V2 (Johnson)             |None, 'C', None, '2015 V2',      |
        |                                | 'Johnson'                       |
        +--------------------------------+---------------------------------+
    ...
    def parse_asteroid(s):
        ...
        Note that the latter example is a comet designation and not an
